    ...
    <br>
	 ...
	 <?php 
           include '_inc/db.php';
				...
				<center><h4>".$data['fur_type']."</h4></center>
	                             </div>
                                               
                                      <div class='panel-body'>
                                     <a href='#'>
                                      <img class='imgg' src='./images/fur_img/".$data['id'].".jpg' alt='' />
                                      </a>
                                      <a href='single_furniture.php?id=".$data['id']."'><button class='btn-bid'><b> View </b></button> </a>
				      </div>
...
<center><form action="furniture.php" method="post">
...
if(isset($_POST['search'])){
    ...
    $query = mysqli_query($conn,"SELECT * FROM furniture WHERE fur_type LIKE '%$searchq%' OR fur_price LIKE '%$searchq%' OR state LIKE '%$searchq%'") or die("could not search!");
    ...
    if($count == 0)
    {
        ...
        while($row= mysqli_fetch_array($query)){
            ...
            $output .="   <div class='col-md-3 col-sm-3 col-xs-6 team-grids'>
			         ...
			         <div class='panel-heading' style='border-bottom:2px solid #0ab2d2;'>
				<center><h4>$fur_type</h4></center>
	                             </div>
                                     
                                               
                                      <div class='panel-body'>
                                     <a href='#'>
                                      <img class='imgg' src='./images/fur_img/$id.jpg' alt='' />
                                      </a>
                                      <a href='single_furniture.php?id=$id'><button class='btn-bid'><b> View </b></button> </a>
				      </div>
