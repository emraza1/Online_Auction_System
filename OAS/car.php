    ...
    <br>
	 ...
	 <?php 
           include '_inc/db.php';
				...
				<center><h4>".$data['car_title']."</h4></center>
	                             </div>
                                     
                                               
                                      <div class='panel-body'>
                                     <a href='#'>
                                      <img class='imgg' src='./images/car_img/".$data['id'].".jpg' alt='' />
                                      </a>
                                      <a href='single_car.php?id=".$data['id']."'><button class='btn-bid'><b> View </b></button> </a>
				      </div>
...
if(isset($_POST['search'])){
    ...
    $query = mysqli_query($conn,"SELECT * FROM cars WHERE car_title LIKE '%$searchq%' OR car_model LIKE '%$searchq%' OR car_price LIKE '%$searchq%'") or die("could not search!");
