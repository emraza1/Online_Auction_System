  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="_inc/update_jewellery.php?id=<?php echo $result['id']; ?>" onsubmit="return fv()" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Type</label>

                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="jew_type" id="jew_type" required="required" value="<?= $result['jew_type']; ?>"placeholder="Enter Jewellery type">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control"name="jew_material" id="jew_material" required="required" value="<?= $result['jew_material']; ?>"placeholder="Enter Jewellery Material">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="jew_brand" id="jew_brand" required="required" value="<?= $result['jew_brand']; ?>"placeholder="Enter Brand name">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <input type="double" class="form-control" name="jew_price" id="jew_price" required="required" value="<?= $result['jew_price']; ?>"placeholder="Enter Starting Price">
                  </div>
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="file" class="form-control" name="jew_img">
                  </div>
                </div>
