...
<?php include '_inc/sidebar.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="_inc/add collectibles.php" onsubmit="return fv()" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Title</label>

                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="collect_title" id="collect_title" placeholder="Enter Title" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control"name="collect_type" id="collect_type" placeholder="Enter Type" required="required">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <input type="double" class="form-control" name="collect_price" id="collect_price" placeholder="Enter Starting Price" required="required">
                  </div>
                </div>
 ...
 <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="file" class="form-control" name="collect_img" required="required">
                  </div>
                </div>
