  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="_inc/update_furniture.php?id=<?php echo $result['id']; ?>" onsubmit="return fv()" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Type</label>

                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="fur_type" id="fur_type" required="required" value="<?= $result['fur_type']; ?>" placeholder="Enter Furniture Type">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control"name="fur_pieces" id="fur_pieces" required="required" value="<?= $result['fur_pieces']; ?>"  placeholder="Enter number of pieces">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <input type="double" class="form-control" name="fur_price" id="fur_price" required="required" value="<?= $result['fur_price']; ?>" placeholder="Enter Starting Price">
                  </div>
                </div>
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-6">
                  <select class="form-control" name="state" value="<?= $result['state']; ?>" required="required" >
                    <option>New</option>
                    <option>Old</option>
                  </select>
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="file" class="form-control" name="fur_img">
                  </div>
                </div>
