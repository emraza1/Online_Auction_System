  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="_inc/update_property.php?id=<?php echo $result['id']; ?>" onsubmit="return fv()" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Type</label>

                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="property_type" id="property_type" required="required" value="<?= $result['property_type']; ?>"placeholder="Enter Property Type">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control"name="property_loc" id="property_loc" required="required" value="<?= $result['property_loc']; ?>"placeholder="Enter Location">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="rooms" id="rooms" required="required" value="<?= $result['rooms']; ?>"placeholder="Enter number of Rooms">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <input type="double" class="form-control" name="property_price" id="property_price" required="required" value="<?= $result['property_price']; ?>"placeholder="Enter Starting Price">
                  </div>
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="file" class="form-control" name="property_img">
                  </div>
                </div>
